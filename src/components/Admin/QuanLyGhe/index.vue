                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mt-2 mb-2">
                                            ...
                                            <input v-model="update_ghe.ten_ghe" class="form-control mt-2 mb-2"
                                                type="text" name="" id="" />
                                            <label for="">Loại Ghế</label>
                                            <input v-model="update_ghe.loai_ghe" class="form-control mt-2 mb-2"
                                                type="text" name="" id="" />
                                            <label for="">Tên Phòng</label>
                                            <input v-model="update_ghe.id_phong" class="form-control mt-2 mb-2"
                                                type="text" name="" id="" />
                                            <div class="mt-2 mb-2">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button v-on:click="xoaGhe()" type="button" data-bs-dismiss="modal"
...
export default {
    ...
    methods: {
        layDuLieuGhe() {
            baseRequest.get("ghe/data").then((res) => {
                this.listGhe = res.data.data;
            });
        },
        themMoiGhe() {
            baseRequest
                .post("ghe/create", this.create_ghe)
                .then((res) => {
                    if (res.data.status) {
        ...
        capNhapGhe() {
            baseRequest
                .put("ghe/update", this.update_ghe)
                .then((res) => {
                    if (res.data.status) {
                        toaster.success("Thông báo<br>" + res.data.message);
                        this.layDuLieuGhe();
        ...
        xoaGhe() {
            baseRequest
                .delete("ghe/delete/" + this.delete_ghe)
                .then((res) => {
